...
export default function HomePage() {
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <section className="bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-slate-900 dark:to-slate-800 py-20 transition-colors">
      ...
      <section className="py-16 bg-white dark:bg-gray-900 transition-colors">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {/* Highlight Card 1 */}
            <div className="p-6 border border-gray-200 dark:border-gray-700 rounded-lg shadow-sm hover:shadow-md dark:shadow-gray-900/30 transition-all bg-white dark:bg-gray-800 hover:scale-105">
              <div className="text-4xl font-bold text-blue-600 dark:text-blue-400 mb-2">10+</div>
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">Years Experience</h3>
            ...
            <div className="p-6 border border-gray-200 dark:border-gray-700 rounded-lg shadow-sm hover:shadow-md dark:shadow-gray-900/30 transition-all bg-white dark:bg-gray-800 hover:scale-105">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">Happy Clients</h3>
              <p className="text-gray-600 dark:text-gray-400">
            ...
            <div className="p-6 border border-gray-200 dark:border-gray-700 rounded-lg shadow-sm hover:shadow-md dark:shadow-gray-900/30 transition-all bg-white dark:bg-gray-800 hover:scale-105">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">Support Available</h3>
              <p className="text-gray-600 dark:text-gray-400">
